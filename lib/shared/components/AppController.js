	...
	_createClass(AppController, [{
		...
		value: function componentDidMount() {
			document.querySelector("img").addEventListener("load", function () {
				var tags = document.getElementsByClassName('tagline');
		...
		value: function renderLine(text, location) {
			...
			return React.createElement(
				"div",
				null,
				React.createElement("link", { href: "http://localhost:8081/public/home.css", rel: "stylesheet", type: "text/css" }),
				React.createElement(
					"div",
		...
		value: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement("img", { src: "http://localhost:8081/public/home.jpg", style: { maxWidth: '100%' } }),
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								"h1",
								{ style: { fontWeight: 400, fontSize: titleSize } },
